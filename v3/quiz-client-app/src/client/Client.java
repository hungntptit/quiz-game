...
public class Client extends javax.swing.JFrame {
    ...
    private void connectToServer() {
        try {
            ...
            is = new BufferedReader(new InputStreamReader(socketOfClient.getInputStream(), "UTF-8"));
            id = -1;
            new Thread() {
                @Override
                public void run() {
...
//        
        ...
        if (questionCount < questions.size()) {
            ...
            if (!check) {
                if (selected.equals("")) {
                    JOptionPane.showMessageDialog(rootPane, "You must select one option.");
                    return;
                }
            ...
            int n = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to submit?", "Confirm", JOptionPane.YES_NO_OPTION);
...
//                    message = message.replace("\"", "\"");
                    ...
                    java.lang.reflect.Type mapType = new TypeToken<Map<Integer, Question>>() {
                    }.getType();
                    questions = new Gson().fromJson(messageSplit[1], mapType);
                ...
                if (messageSplit[0].equals("timer")) {
                    lblTime.setText(messageSplit[1]);
                }
                if (messageSplit[0].equals("completed")) {
